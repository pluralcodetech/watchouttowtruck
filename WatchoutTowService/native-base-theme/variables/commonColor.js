...
import FONTS from '../../app/src/conts/fonts';
...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? FONTS.regular : FONTS.regular,
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? COLORS.primary : COLORS.primary,
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'System' : FONTS.regular,
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : COLORS.white,
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : COLORS.white,
  get statusBarColor() {
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'System' : FONTS.bold,
